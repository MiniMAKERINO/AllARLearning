...
public class AudioCtrl : MonoBehaviour
{
    ...
    public void ToggleAudio() //Toggle audio and mute/unmute icon function
    {
        ...
        /* Get state of the unmute and mute icons for LandscapeLeft canvas as a bool, then switches the 'active-state' of the icons
        to display one at a time, and let the user know that SFX is either ON or OFF. */
        ...
        /* Get state of the unmute and mute icons for LandscapeRight canvas as a bool, then switches the 'active-state' of the icons
        to display one at a time, and let the user know that SFX is either ON or OFF. */
